...
![SF Symbols Version](https://img.shields.io/badge/SF%20Symbols-7.3-blue?style=flat&logo=apple&logoColor=white)
![SF Symbols Count](https://img.shields.io/badge/Symbols-7007-blue?style=flat&logo=apple&logoColor=white)
...
│   │   ├── Commerce.txt
│   │   └── ...
│   ├── monochrome/         # Monochrome rendering mode
│   │   └── svgs.txt
│   ├── hierarchical/       # Hierarchical rendering mode
│   │   └── svgs.txt
│   ├── palette/            # Palette rendering mode
│   │   └── svgs.txt
│   └── multicolor/         # Multicolor rendering mode
│       └── svgs.txt
...
The directories are organized by SF Symbol rendering modes:
...
| `<renderingMode>` | SF Symbol rendering mode | `monochrome`, `hierarchical`, `palette`, `multicolor` |
